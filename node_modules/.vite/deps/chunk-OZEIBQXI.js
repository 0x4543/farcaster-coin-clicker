...
// node_modules/@reown/appkit-utils/node_modules/pino/browser.js
var require_browser = __commonJS({
  "node_modules/@reown/appkit-utils/node_modules/pino/browser.js"(exports, module) {
    "use strict";
  ...
  checkSDKVersion(version) {
    ...
    if (this.isValidVersion(appKitVersionStorage)) {
      if (this.isOlder(packageVersion, appKitVersionStorage)) {
        console.warn(ConstantsUtil3.getSDKVersionWarningMessage(packageVersion, appKitVersionStorage));
        return;
      }
    }
    try {
      fetch("https://registry.npmjs.org/@reown/appkit/latest").then((response) => response.json()).then((data) => {
        ...
        if (this.isOlder(packageVersion, latestVersion)) {
          ...
          console.warn(ConstantsUtil3.getSDKVersionWarningMessage(packageVersion, latestVersion));
        }
      });
    } catch (error) {
    }
...
// node_modules/@reown/appkit-utils/node_modules/@walletconnect/logger/dist/index.es.js
...
//# sourceMappingURL=chunk-OZEIBQXI.js.map
