...
var OptionsUtil = {
  ...
  isSocialsEnabled() {
    var _a, _b, _c, _d;
    return Array.isArray((_a = OptionsController.state.features) == null ? void 0 : _a.socials) && ((_b = OptionsController.state.features) == null ? void 0 : _b.socials.length) > 0 || Array.isArray((_c = OptionsController.state.remoteFeatures) == null ? void 0 : _c.socials) && ((_d = OptionsController.state.remoteFeatures) == null ? void 0 : _d.socials.length) > 0;
  },
  isEmailEnabled() {
    var _a, _b;
...
async function loadViemUtils() {
  if (!cachedViemUtils) {
    const { createPublicClient, http, defineChain } = await import("./_esm-E4VWOONK.js");
    cachedViemUtils = {
      createPublicClient,
      http,
      defineChain
...
//# sourceMappingURL=chunk-UQBMRNYB.js.map
